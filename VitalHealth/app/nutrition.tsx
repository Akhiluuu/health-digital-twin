...
export function scaleNutrients(food: CsvFoodItem, multiplier: number) {
  return {
...
export function getCategoryColor(category: string, colors: Record<string, string>): string {
...
export function getQuickQuantities(base: number, unit: string): number[] {
...
type BioGearsMealType = "balanced" | "custom" | "fast_food" | "high_carb" | "high_protein" | "ketogenic";

function toBioGearsMealType(slotId: string): BioGearsMealType {
  const map: Record<string, BioGearsMealType> = {
    breakfast: "balanced",
    morning_snack: "balanced",
    lunch: "balanced",
    afternoon_snack: "balanced",
    dinner: "balanced",
    evening_snack: "balanced",
    snack: "balanced",
    balanced: "balanced",
    custom: "custom",
    fast_food: "fast_food",
