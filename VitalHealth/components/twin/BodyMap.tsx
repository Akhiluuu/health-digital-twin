    ...
    switch (key) {
      ...
      case 'heart':
        return [
          ...
          { label: 'Blood Pressure', value: v.blood_pressure || (p.biogears_systolic_bp && p.biogears_diastolic_bp ? `${p.biogears_systolic_bp}/${p.biogears_diastolic_bp}` : '120/80 mmHg'), range: '120/80 mmHg' },
          { label: 'Cardiac Output', value: v.cardiac_output ? `${v.cardiac_output.toFixed(1)} L/min` : '5.2 L/min', range: '4.5 - 6.0 L/min' },
        ];
      case 'lungs':
        return [
