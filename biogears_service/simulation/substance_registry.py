...
SUBSTANCE_REGISTRY: Dict[str, Any] = {
    ...
    "Insulin": {
        ...
        "category": "Hormone",
        "safe_min": 0.1, "safe_max": 20.0,
        "safety_level": "caution",
        "warning": "⚠️ INSULIN — Hypoglycemia risk. Dosed in Units (U). Monitor glucose closely.",
        "note": "Typical single bolus: 1–10 U. 1 U ≈ 0.0347 mg.",
    ...
    "Blood_ABNegative": {
        ...
        "safety_level": "clinical_only",
        "warning": "⚠️ Type & crossmatch required. Transfusion reaction risk.",
        "note": "AB- negative blood product. Infusion rate 1–4 mL/min.",
        "effects": "↑ Hgb, ↑ O2 carrying capacity",
    },
    "Blood_ABPositive": {
        "route": "IV_COMPOUND", "unit": "mL/min",
        ...
        "safety_level": "clinical_only",
        "warning": "⚠️ Type & crossmatch required. Transfusion reaction risk.",
        "note": "AB+ positive blood product. Infusion rate 1–4 mL/min.",
        "effects": "↑ Hgb, ↑ O2 carrying capacity",
    },
    "Blood_ANegative": {
        "route": "IV_COMPOUND", "unit": "mL/min",
        ...
        "safety_level": "clinical_only",
        "warning": "⚠️ Type & crossmatch required. Transfusion reaction risk.",
        "note": "A- negative blood product. Infusion rate 1–4 mL/min.",
        "effects": "↑ Hgb, ↑ O2 carrying capacity",
    },
    "Blood_BNegative": {
        "route": "IV_COMPOUND", "unit": "mL/min",
        ...
        "safety_level": "clinical_only",
        "warning": "⚠️ Type & crossmatch required. Transfusion reaction risk.",
        "note": "B- negative blood product. Infusion rate 1–4 mL/min.",
        "effects": "↑ Hgb, ↑ O2 carrying capacity",
    },
    "Blood_BPositive": {
        "route": "IV_COMPOUND", "unit": "mL/min",
        ...
        "safety_level": "clinical_only",
        "warning": "⚠️ Type & crossmatch required. Transfusion reaction risk.",
        "note": "B+ positive blood product. Infusion rate 1–4 mL/min.",
        "effects": "↑ Hgb, ↑ O2 carrying capacity",
    },
    "Blood_OPositive": {
        "route": "IV_COMPOUND", "unit": "mL/min",
        ...
        "safety_level": "clinical_only",
        "warning": "⚠️ Type & crossmatch required. Transfusion reaction risk.",
        "note": "O+ positive blood product. Infusion rate 1–4 mL/min.",
        "effects": "↑ Hgb, ↑ O2 carrying capacity",
    },
    ...
    "Piperacillin": {
        ...
        "safe_min": 1000, "safe_max": 4000,
        "safety_level": "clinical_only",
        "warning": "⚠️ Hypersensitivity/allergy risk. Monitor renal function.",
        "note": "Broad-spectrum beta-lactam antibiotic.",
        "effects": "Bactericidal action",
    },
    "Tazobactam": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Beta-Lactamase Inhibitor",
        "safe_min": 125, "safe_max": 500,
        "safety_level": "clinical_only",
        "warning": "⚠️ Administered with piperacillin. Monitor renal function.",
        "note": "Prevents bacterial destruction of beta-lactam antibiotics.",
        "effects": "Enhances antibiotic efficacy",
    },
    "PiperacillinTazobactam": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Antibiotic Combo",
        "safe_min": 1125, "safe_max": 4500,
        "safety_level": "clinical_only",
        "warning": "⚠️ Allergy/anaphylaxis risk. Piperacillin + Tazobactam combination.",
        "note": "Standard clinical dose: 3.375g - 4.5g.",
        "effects": "Broad-spectrum antibacterial coverage",
    },
    ...
    "Sodium": {
        ...
        "safe_min": 100, "safe_max": 2000,
        "safety_level": "caution",
        "warning": "⚠️ Rapid changes in sodium concentration can cause osmotic demyelination.",
        "note": "Main extracellular cation. Regulates fluid balance.",
        "effects": "Regulates blood volume and pressure",
    },
    "Potassium": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Electrolyte",
        "safe_min": 50, "safe_max": 1000,
        "safety_level": "danger",
        "warning": "🚨 HIGH RISK — Rapid potassium infusion can cause cardiac arrest / arrhythmias.",
        "note": "Main intracellular cation. Crucial for cellular membrane potential.",
        "effects": "Supports cardiac and neuromuscular conduction",
    },
    "Chloride": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Electrolyte",
        "safe_min": 100, "safe_max": 2000,
        "safety_level": "caution",
        "warning": "⚠️ Monitor for hyperchloremic metabolic acidosis.",
        "note": "Major extracellular anion. Maintains osmotic pressure.",
        "effects": "Fluid balance and acid-base regulation",
    },
    "Calcium": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Electrolyte",
        "safe_min": 100, "safe_max": 1000,
        "safety_level": "caution",
        "warning": "⚠️ Inject slowly. Rapid IV injection may cause peripheral vasodilation and hypotension.",
        "note": "Essential for muscle contraction and coagulation.",
        "effects": "Cardiovascular support, cardiac contractility",
    },
    "Magnesium": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Electrolyte",
        "safe_min": 100, "safe_max": 2000,
        "safety_level": "caution",
        "warning": "⚠️ Rapid infusion can cause vasodilation, flushing, and hyporeflexia.",
        "note": "Cofactor in enzymatic reactions, treats preeclampsia/torsades.",
        "effects": "Neuromuscular blockade / smooth muscle relaxation",
    },
    "Bicarbonate": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Electrolyte / Buffer",
        "safe_min": 500, "safe_max": 5000,
        "safety_level": "caution",
        "warning": "⚠️ Hypernatremia and metabolic alkalosis risk.",
        "note": "Treats severe metabolic acidosis.",
        "effects": "↑ blood pH, buffers excess acid",
    },
    ...
    "Glucagon": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Hormone",
        "safe_min": 0.5, "safe_max": 1.0,
        "safety_level": "caution",
        "warning": "⚠️ Glucagon — Rapidly raises blood glucose. May cause nausea.",
        "note": "Used to treat severe hypoglycemia in diabetics.",
        "effects": "↑ blood glucose via glycogenolysis",
    },
    "Glucose": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Metabolic",
        "safe_min": 500, "safe_max": 25000,
        "safety_level": "caution",
        "warning": "⚠️ Treats acute hypoglycemia. Monitor blood glucose.",
        "note": "Dextrose IV solution (e.g., D50W bolus).",
        "effects": "↑ blood glucose, cellular energy substrate",
    },
    "Albumin": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Plasma Protein",
        "safe_min": 5000, "safe_max": 25000,
        "safety_level": "clinical_only",
        "warning": "⚠️ Volume overload risk in heart failure or renal disease.",
        "note": "Restores oncotic pressure in volume depletion/shock.",
        "effects": "Plasma expansion, ↑ oncotic pressure",
    },
    "Globulin": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Plasma Protein",
        "safe_min": 1000, "safe_max": 10000,
        "safety_level": "clinical_only",
        "warning": "⚠️ Risk of transfusion/allergic reactions.",
        "note": "Plasma globulins (immunoglobulins/transporters).",
        "effects": "Humoral immunity and transportation",
    },
    "Desflurane": {
        "route": "NASAL", "unit": "ug",
        "category": "Inhalation Anesthetic",
        "safe_min": 100, "safe_max": 10000,
        "safety_level": "clinical_only",
        "warning": "🚨 ANESTHETIC GAS — Respiratory depression, airway irritation.",
        "note": "Used for maintenance of general anesthesia.",
        "effects": "↓↓ RR, general anesthesia, vasodilation",
    },
    "Acetoacetate": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Metabolic / Ketone",
        "safe_min": 10, "safe_max": 1000,
        "safety_level": "clinical_only",
        "warning": "⚠️ High levels indicate ketoacidosis.",
        "note": "Ketone body metabolized for energy.",
        "effects": "Alternative energy substrate",
    },
    "Lactate": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Metabolic",
        "safe_min": 10, "safe_max": 1000,
        "safety_level": "clinical_only",
        "warning": "⚠️ Elevated levels indicate tissue hypoxia / acidosis.",
        "note": "Byproduct of anaerobic glycolysis.",
        "effects": "Metabolized by liver into bicarbonate",
    },
    "Urea": {
        "route": "IV_BOLUS", "unit": "mg",
        "category": "Metabolic",
        "safe_min": 10, "safe_max": 1000,
        "safety_level": "clinical_only",
        "warning": "⚠️ Main nitrogenous waste product.",
        "note": "Assesses renal clearance and hydration.",
        "effects": "Osmotic diuretic agent",
    },
    "SalineSlowDrip": {
        "route": "IV_COMPOUND", "unit": "mL/min",
        "category": "IV Fluid",
        ...
        "safety_level": "safe",
        "warning": None,
        "note": "Saline infusion at maintenance rate.",
        "effects": "Maintenance hydration",
    },
}
